...
import { OverviewNewEventModal } from '@/app/calendar-events/client/react/components/modal-new-event/overview-new-event-modal/overview-new-event-modal'
            ...
            <Box sx={styleModal}>
                <Box sx={{ py: 1 }} display={'flex'} flexDirection={'column'}>
                    ...
                    <Breadcrumbs aria-label="breadcrumb" sx={{ px: 1 }}>
                        {Object.keys(newEventModalStepsLabel).map((step) => (
                            <Button
                            ...
                            >
                                {newEventModalStepsLabel[step as keyof NewEventModalStepsLabel]}
                            </Button>
                        ))}
                    </Breadcrumbs>
                </Box>
                ...
                <Box flexGrow={1}>
                    ...
                    {currentStep === 'OVERVIEW' && <OverviewNewEventModal />}
                </Box>
            </Box>
        </Modal>
    )
...
export type NewEventModalStepsLabel = typeof newEventModalStepsLabel
