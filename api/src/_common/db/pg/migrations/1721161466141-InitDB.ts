...
export class InitDB1721161466141 implements MigrationInterface {
    name = 'InitDB1721161466141'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "event_organizer_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "email" character varying NOT NULL, "website" character varying, "contacts" json, CONSTRAINT "PK_29163f1d3c9f12a68b32a79ffe0" PRIMARY KEY ("id"))`);
